...
<section class="content">
    ...
    <?php
          ...
          $totalStudents = DB::table('question_bank_result')->where('topic_id',$result->topic_id)->orderBy('correct_questions','DESC')->get();
          $rank = DB::table('question_bank_result')
					->where('topic_id', $topic_id)
					->where('correct_questions', '>', function ($query) use ($topic_id,$user_id) {
