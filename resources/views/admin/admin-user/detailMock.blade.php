...
<section class="content">
    ...
    <?php
          ...
          $totalStudents = DB::table('mockup_test_result')->where('mock_id',$result->mock_id)->orderBy('marks','DESC')->get();
...
<script>
    ...
    const chartData = {
        ...
        datasets: [{
            label: 'Questions',
            data: [<?= $result->right_answers; ?>, <?= $result->wrong_answers; ?>, <?= $result->total_questions-$result->attempted_questions; ?>],
            backgroundColor: [
