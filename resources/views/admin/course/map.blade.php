				...
				<div class="card">
					...
					<div class="body">
						<div class="btn-group top-head-btn">
							<a class="btn-primary" href="{{ url('admin/course/list')}}">
		...
		<div class="row">
			<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
				<div class="card">
					...
					<div class="body">
						<form id="form" action="{{ route('admin.course.map') }}" method="post" enctype="multipart/form-data" autocomplete="off">
							@csrf
								...
								<div class="col-sm-12">
									<div class="form-group">
										<div class="form-line">
											...
											<select class="form-control courseHtml" id="course_master_id" name="course_id" required>
												<option selected value="">--Select--</option>
												@if(!empty($courses))
