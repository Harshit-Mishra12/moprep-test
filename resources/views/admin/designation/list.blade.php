...
@section('title',__('designation List'))
    ...
    <div class="container-fluid">
				...
				<div class="card">
					...
					<div class="body">
						...
						<div class="btn-group top-head-btn">
                            <a class="btn-primary" href="{{ url('admin/designation/add') }}">
        ...
        <div class="row">
            <div class="col-lg-12 col-md-12 col-sm-12">
                <div class="card">
					<div class="header">
						<h2><i class="fa fa-th"></i> Designation List</h2>
					</div>
                    <div class="body">
                        <div class="table-">
												...
												@if(!empty($result))
													@foreach($result as $key=>$value)
														<tr class="gradeX odd">
															...
															<td class="center">{{ $value->designations }}</td>
															...
															<td class="center">
																...
																<td class="center">
                                                                    @if(isset($permission) && $permission['edit'] == 'true' && $value->designations != 'Super Admin')
																	<a href="{{ url('admin/designation/update/'.$value['id'] )}}" title="Edit designation" class="btn btn-tbl-edit">
																		<i class="fas fa-pencil-alt"></i>
																	</a>
                                                                    @endIf
                                                                    
                                                                    @if(isset($permission) && $permission['delete'] == 'true' && $value->designations != 'Super Admin')
																	<a title="Delete designation" onclick="return confirm('Are you sure? You want to delete this designation.')" href="{{ url('admin/designation/delete/'.$value['id'] )}}" class="btn btn-tbl-delete">
    ...
    <script>
        ...
        $('.-change').change(function() {
            ...
            $.ajax({
                type: "POST",
                dataType: "json",
                url: "{{ route('admin.designation.changestatus') }}",
				headers: {
