    ...
    <div class="container-fluid">
				...
				<div class="card">
					...
					<div class="body">
						<div class="btn-group top-head-btn">
                            <a class="btn-primary" href="{{ url('admin/faq/add') }}">
        ...
        <div class="row">
            <div class="col-lg-12 col-md-12 col-sm-12">
                <div class="card">
					<div class="header">
						<h2><i class="fa fa-th"></i> FAQ List</h2>
					</div>
                    <div class="body">
                        <div class="table-">
													...
													@foreach($result as $key=>$value)
														<tr class="gradeX odd"  id="{{ $value->id }}">
                                                            ...
                                                            <td class="center">
                                                                ...
                                                                <a href="{{ url('admin/faq/update/'.$value['id'] )}}" title="Edit FAQ" class="btn btn-tbl-edit">
                                                                    <i class="fas fa-pencil-alt"></i>
                                                                </a>
                                                                <a title="Delete FAQ" onclick="return confirm('Are you sure? You want to delete this course.')" href="{{ url('admin/faq/delete/'.$value['id'] )}}" class="btn btn-tbl-delete">
