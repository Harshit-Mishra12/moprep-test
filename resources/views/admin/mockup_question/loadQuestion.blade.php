                                            ...
                                            <tbody class="row_position">
                                                ...
                                                @endphp
                                                    ...
                                                    <?php
                                                      ...
                                                      $checkPrev = DB::table('mock_questions')->where(['mock_id'=>$mock_id,'question_id'=>$value->id])->count();
                                                      
                                                      
                                                    ?>
														<tr class="gradeX odd"  id="{{ $value->id }}">
                                                            <td class="center"><?php if($checkPrev==0){ ?> <input class="slaveCheckbox" type="checkbox" name="selectedQuestion[]"  value="{{ $value->id }}"><?php }else{ echo "Allotted"; } ?></td>
