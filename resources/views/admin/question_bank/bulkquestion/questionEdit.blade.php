		...
		<div class="row">
			<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
				<div class="card">
					...
					<div class="body">
						<form id="form" action="{{ route('admin.questionBank.update_question') }}" method="post" enctype="multipart/form-data" autocomplete="off">
						@csrf
                                    ...
                                    <div class="form-group">
                                        <div class="form-line">
                                            ...
                                            <select class="form-control" name="right_option" required >
												...
												<option	@if(!empty($result) && strstr($result['right_option'],'a')){{'selected'}}@endif value="a">A</option>
												<option @if(!empty($result) && strstr($result['right_option'],'b')){{'selected'}}@endif value="b">B</option>
												<option @if(!empty($result) && strstr($result['right_option'],'c')){{'selected'}}@endif value="c">C</option>
												<option @if(!empty($result) && strstr($result['right_option'],'d')){{'selected'}}@endif value="d">D</option>
                                            </select>
                                        </div>
                                    </div>
                                </div>
