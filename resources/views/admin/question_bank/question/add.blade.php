		...
		<div class="row">
			<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
				<div class="card">
					...
					<div class="body">
						<form id="form" action="{{ route('admin.question_bank.question.add_question') }}" method="post" enctype="multipart/form-data" autocomplete="off">
							@csrf
								...
								<div class="col-sm-6" id="">
									<div class="form-group">
										<div class="form-line">
											...
											<select class="form-control yearSelect" required name="year_id" id="year_id">
...
<script src="https://cdn.jsdelivr.net/npm/summernote@0.8.18/dist/summernote-lite.min.js"></script>
	...
	$('.topicHtml').change(function() {
		...
		$.ajax({
			url: baseUrl + '/admin/question_bank/question/loadQuestion?id='+yearId+'&subject_id='+subject_id+'&chapter_id='+chapter_id+'&topic_id='+topic_id,
			dataType: 'json',
			type: 'get',
			error: function(xhr, textStatus) {
				if (xhr && xhr.responseJSON.message) {
	...
	$('.yearSelect').change(function() {
		var yearId=$('#year_id').val();
		$.ajax({
			url: baseUrl + '/admin/question_bank/question/loadQuestion?id='+yearId,
			dataType: 'json',
			type: 'get',
			error: function(xhr, textStatus) {
				if (xhr && xhr.responseJSON.message) {
